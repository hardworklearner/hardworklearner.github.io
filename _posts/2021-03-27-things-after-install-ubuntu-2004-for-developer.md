...
[Here is download file of the install scrip](https://raw.githubusercontent.com/hardworklearner/hardworklearner.github.io/master/download/install.sh)

_For a quick setup, I recommend that you create a file called `install.sh` and run the following command every time you install:_
